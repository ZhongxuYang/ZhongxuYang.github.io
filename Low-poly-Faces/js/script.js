...
window.onload = function(){
	...
	var about_me_box = document.getElementById('about_me_box');
...
/*-------------personage-canvas---------------*/
	...
	(function(){
		...
		window.onhashchange = function(){
			...
			if(hash == 'me'){
				about_me_box.style.display = 'block';
				about_me.style.transform = 'scale(1)';
				about_me.style.webkitTransform = 'scale(1)';
			}else{
				clickFn(hash);
				changeInfo(hash);
			}
